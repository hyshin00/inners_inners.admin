<template>
  <n-popover class="!p-0" trigger="click" placement="bottom">
    <template #trigger>
      <hover-container tooltip-content="消息通知" :inverted="theme.header.inverted" class="relative h-full w-40px">
    ...
    >
      <n-tab-pane v-for="(item, index) in tabData" :key="item.key" :name="index">
        <template #tab>
          <div class="items-center flex-x-center" :class="[isMobile ? 'w-92px' : 'w-120px']">
...
const tabData = ref<Message.Tab[]>([
  {
    ...
    list: [
      ...
      { id: 4, icon: 'ri:message-3-line', title: 'innerS Admin 1.0.0 版本正在筹备中', date: '2022-06-17' },
      { id: 2, icon: 'ri:message-3-line', title: 'innerS Admin 0.9.6 版本发布了', date: '2022-06-16' },
      { id: 3, icon: 'ri:message-3-line', title: 'innerS Admin 0.9.5 版本发布了', date: '2022-06-07' },
      {
        id: 5,
    ...
    list: [
      {
        ...
        title: '项目动态',
        svgIcon: 'avatar',
        description: 'innerS 刚才把工作台页面随便写了一些，凑合能看了！',
      ...
      },
      {
        ...
        title: '项目动态',
        svgIcon: 'avatar',
        description: 'innerS 正在忙于为soybean-admin写项目说明文档！',
      ...
      },
      {
        ...
        title: '项目动态',
        svgIcon: 'avatar',
        description: 'innerS 准备为soybean-admin 1.0的发布做充分的准备工作！',
      ...
      },
      {
        ...
        title: '项目动态',
        svgIcon: 'avatar',
        description: 'innerS 在2021年5月28日创建了开源项目soybean-admin！',
  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        id: 2,
        icon: 'ri:calendar-todo-line',
        title: '잠금 화면 구성 요소, 글로벌 iframe 구성 요소를 추가하십시오',
        description: '작업이 계획하고 있습니다',
        date: '2022-06-17',
        tagTitle: '시작되지 않았습니다',
        tagProps: { type: 'default' }
