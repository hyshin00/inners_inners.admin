<template>
  <div>
    <n-card title="버튼" class="h-full shadow-sm rounded-16px">
      <n-grid cols="s:1 m:2" responsive="screen" :x-gap="16" :y-gap="16">
        ...
        <n-grid-item class="h-180px">
          <n-card title="로딩" class="h-full">
            <p class="pb-16px">버튼이 로드되었습니다.</p>
            <n-space>
              <n-button :loading="loading" type="primary" @click="startLoading">로딩을 시작하십시오</n-button>
              <n-button @click="endLoading">로딩을 취소하십시오</n-button>
            </n-space>
          </n-card>
        </n-grid-item>
      </n-grid>
...
const buttonExample: ButtonExample[] = [
  {
    ...
    desc: '버튼 type 각기 default、primary、info、success、warning error。'
  },
  {
    id: 1,
    label: '보조 버튼',
