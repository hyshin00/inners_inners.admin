...
const technology: Technology[] = [
  ...
  },
  {
    ...
    site: 'https://www.naiveui.com/ko-KR/os-theme',
    icon: 'logos:naiveui'
  },
  {
    id: 4,
...
const activity: Activity[] = [
  { id: 4, content: 'innerS 刚才把工作台页面随便写了一些，凑合能看了！', time: '2021-11-07 22:45:32' },
  { id: 3, content: 'innerS 正在忙于为soybean-admin写项目说明文档！', time: '2021-11-03 20:33:31' },
  { id: 2, content: 'innerS 准备为soybean-admin 1.0的发布做充分的准备工作！', time: '2021-10-31 22:43:12' },
  { id: 1, content: '@yanbowe 向soybean-admin提交了一个bug，多标签栏不会自适应。', time: '2021-10-27 10:24:54' },
  { id: 0, content: 'innerS 在2021年5月28日创建了开源项目soybean-admin！', time: '2021-05-28 22:22:22' }
];
